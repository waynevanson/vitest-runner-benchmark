...
export type CollapsibleOutput<
  TEntries extends Record<string, Schema<unknown>>
> = {
...
>(entries: TEntries): Collapsible<TContext, CollapsibleOutput<TEntries>> {
  return { type: "Collapsible", entries }
}
